...
export class DragComponent implements OnInit {
  ...
  dragImage(){
    let imagArea = document.getElementById("display");
    console.log(imagArea);
    this.renderer.listen(imagArea, "mousedown", this.editImgArea);
  }

  editImgArea(ev){
    var selectedArea = document.getElementById("display");
    ...
    // selectedArea.style.width = selectedArea.style.width || selectedArea.offsetWidth.toString();
    // selectedArea.style.height = selectedArea.style.height || selectedArea.offsetHeight.toString();
